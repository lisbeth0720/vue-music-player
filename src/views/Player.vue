<template>
    <div id="playContent">
        ...
        <div class="lrcContent">
            <ul ref="ulList">
                <li v-for="(item,index) in lrcContent" 
                    :key="index" 
                    :dataindex="index">
                    {{item}}
                </li>
...
export default {
    ...
    methods: {
         getNowInfo(id) {
            ...
            //模拟的数据
            var newurl = serverUrl +"data/nowPlay_1.json";
            if(id==1){

            }else if(id==2){
                newurl = serverUrl + "data/nowPlay_2.json";
            }else if(id==3){
                newurl = serverUrl + "data/nowPlay_3.json";
            }else if(id==4){
                newurl = serverUrl + "data/nowPlay_4.json";
            } else if (id == 5){
                newurl = serverUrl + "data/nowPlay_5.json";
            } else if (id == 6){
                newurl = serverUrl + "data/nowPlay_6.json";
            }
            request1({
                url: newurl,
                methods: 'get'
